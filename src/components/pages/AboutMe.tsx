...
import PortugueseResume from "../../assets/docs/curriculo-victor-magalhaes.pdf"
import EnglishResume from "../../assets/docs/resume-victor-magalhaes.pdf"
		...
		<div className="rounded-3xl p-8 flex flex-col items-center text-center">
			...
			<div className="flex flex-col">
				...
				<div className="flex flex-row gap-3">
					<a href={`${PortugueseResume}`} download target="_blank">
					...
					<a href={`${EnglishResume}`} download target="_blank">
						<button className="btn btn-outline gap-2">
							<svg width={24} height={24} fill="none" viewBox="0 0 24 24">
